device_tracker_art
==============
This is the Ubitrack device_tracker_art submodule.

Description
----------
The device_tracker_art contains components to connect to ART Tracking Services via network.
...
If you handle multiple dependencies in your project is better to add a *conanfile.txt*
    ...
    [requires]
    ubitrack_device_tracker_art/1.3.0@ubitrack/stable
...
## Upload
    ...
    $ conan upload -r ubitrack ubitrack_device_tracker_art/1.3.0@ubitrack/stable
